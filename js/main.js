...
// Criando o Swiper
var keys = [ //Vetor para quando clicar aparecer X planeta
    "Mercurio",
    "Vênus",
    "Terra",
    "Marte",
  ...
  var slider = new Swiper(".swiper-container", {
    ...
    pagination: {
      el: ".planet-links",
      clickable: true,
      renderBullet: function(index, nomeClass) {
        return '<div class="' + nomeClass + '">' + keys[index] + "</div>";
      }
    }
  });

  // ANIMAÇÃO COM O SLIDE GSAP
